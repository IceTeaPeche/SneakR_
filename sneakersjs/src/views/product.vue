...
<section>
    <article v-for="data in datas" :key="data.id">
      ...
      <div class="flex justify-center mt-6">
            <span @click="moreproduct" class="bg-white-500 text-gray-700 Lugrasimo py-2 px- rounded mr-0" style="font-family: 'Your Custom Font', sans-serif;">
              Voir plus
            </span>
          </div>
...
<div class="pagination flex items-center justify-center mt-4">
    ...
    <footer class="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400"> Sneakers. All Rights Reserved.</span>
        </div>
    </footer>
