<template>
        ...
        <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
            <nav>
                <ul
                    ...
                    <li>
                        <a @click="pushhome" href="#"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                            aria-current="page">home</a>
                    </li>
                    <li>
                        <a @click="pushproduct" href="#" id="product"
                            class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500">product</a>
                    </li>
    ...
    <section>
        <article v-for="data in datas" :key="data.id">
            <div class="w-60 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
                ...
                <div class="px-3 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold trackin g-tight text-gray-900 dark:text-white">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-3xl font-bold text-gray-900 dark:text-white ml-3">{{ data.attributes.retailPrice }}
                        €</span>
                    <div class="flex">
    ...
    <div class="flex justify-center mt-6">
        <a @click="moreproduct" class="bg-white-500 text-gray-700 Lugrasimo py-2 px- rounded mr-0"
    ...
    methods: {
        ...
        async fetchData() {
            try {
                ...
                const response = await fetch(`http://localhost:1337/api/snickers?pagination%5Bpage%5D=${this.currentPage}&_q=${this.search}&pagination%5BpageSize%5D=${this.nombredeproduct}`);
