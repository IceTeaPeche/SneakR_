<template >
        ...
        <header class="lg:px-16 px-6 bg-white flex flex-wrap items-center lg:py-0 mt-3 py-2 mb-3">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
                ...
                <div class="relative group inline-block lg:ml-6 flex lg:mb-0 mb-4 pointer-cursor">
                    ...
                    <div
                        class="absolute hidden mt-9 py-2 w-48 bg-white rounded-lg shadow-xl group-hover:block left-[-120px]">
        ...
        <section>
            <article v-for="data in datas" :key="data.id">
                <div
                    class="w-60 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
